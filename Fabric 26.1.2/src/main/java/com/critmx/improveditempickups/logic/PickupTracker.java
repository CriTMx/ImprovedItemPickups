...
import com.critmx.improveditempickups.logic.pickup.PickupEntry;
import com.critmx.improveditempickups.logic.pickup.PickupKey;
...
public class PickupTracker {
    ...
    public void recordPickup(ItemStack stack) {
        if (stack == null) {
            ImprovedItemPickups.LOGGER.error("[{}] Null/invalid item pickup detected.", ImprovedItemPickups.MOD_ID);
            return;
        }
